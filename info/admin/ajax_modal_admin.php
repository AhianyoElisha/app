...
$sel_query=mysqli_query($con, "select * from HR_ADMIN where ID='$id'") or die(mysql_error($con)); 
$selrow=mysqli_fetch_array($sel_query,MYSQLI_ASSOC);
?>

<div class="modal-header">
    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
    <h4 class="modal-title" id="myModalLabel">Reset Admin Password</h4>
</div>
<div class="modal-body">
    <div class="login-box" style="width:100%">
        <!-- /.login-logo -->
        <p class="login-box-msg"><label style="margin-right:5px">Admin ID :</label><?php echo $selrow[ 'ID']?></p>
        <div class="login-box-body" id="div1">
            <form action="<?php echo htmlentities($_SERVER['PHP_SELF'])?>" method="post">
                <div class="row">
                    <div class="col-lg-6">
                        <div class="form-group">
                             <img class="profile-user-img img-responsive img-circle" style="width:100px;height:100px" src="../../uploads/user-profile-svgrepo-com.svg" alt="User profile picture">                   
                        </div>
                        <div class="form-group">
                            <p><label>Name : </label>
                    ...
                    <div class="col-lg-6">
                        ...
                        <input type="hidden" name="staffid" value="<?php echo $selrow['ID']?>">
                ...
                <div class="form-group">
                    ...
                    <button type="submit" name="reset_admin" class="btn btn-primary btn-flat pull-right">Reset Password</button>
                </div>
            </form>
        </div>
        <!-- /.login-box-body -->
...
if (isset($_POST['reset_admin'])) {
    ...
    if ($result) {
        ...
        if ($passw == $repassw) {
        $query1 = "UPDATE `HR_ADMIN` SET `entry_password`= '$passw' WHERE `ID`= '$usern'";
        $query2 = "INSERT INTO HR_ADMIN_ACCESS_FOR_ADMIN  (`Admin_ID`,`Fname`,`Lname`,`change_made_on`,`changed_password_to`)  VALUES ($admin,'$admin_fname','$admin_lname',$usern,'$passw');";
