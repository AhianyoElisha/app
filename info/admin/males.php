        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            ...
            <div class="box-body" style="overflow-x:auto;">
              <?php
              include('../../backend/connection.php');
              $query = "SELECT * FROM STAFF WHERE Seconded = 1 AND `Disable` = 0 AND `Sex` = 'M'";
              $query_run = mysqli_query($con,$query);
              ?>
        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            ...
            <div class="box-body" style="overflow-x:auto;">
              <?php
              include('../../backend/connection.php');
              $query = "SELECT * FROM STAFF WHERE  Rank_Status ='Senior' AND `Disable` = 0 AND `Sex` = 'M'";
              $query_run = mysqli_query($con,$query);
              ?>
        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            ...
            <div class="box-body" style="overflow-x:auto;">
              <?php
              include('../../backend/connection.php');
              $query = "SELECT * FROM STAFF WHERE  Rank_Status ='Junior' AND `Disable` = 0 AND `Sex` = 'M'";
              $query_run = mysqli_query($con,$query);
              ?>
        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            ...
            <div class="box-body" style="overflow-x:auto;">
              ...
              include('../../backend/connection.php');
              $date = 
              $query = "SELECT `Staff_ID`, `Lname`, `Mname`, `Fname`, (YEAR(CURRENT_DATE)-YEAR(DOB)) AS Age, `Marital_Status` FROM STAFF WHERE YEAR(CURRENT_DATE)-YEAR(DOB) < 31 AND `Disable` = 0 AND `Sex`='M'";
              $query_run = mysqli_query($con,$query);
              ?>
        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            ...
            <div class="box-body" style="overflow-x:auto;">
              <?php
              include('../../backend/connection.php');
              $query = "SELECT `Staff_ID`, `Lname`, `Mname`, `Fname`, (YEAR(CURRENT_DATE)-YEAR(DOB)) AS Age, `Marital_Status` FROM STAFF WHERE YEAR(CURRENT_DATE)-YEAR(DOB) > 30 AND YEAR(CURRENT_DATE)-YEAR(DOB) < 41 AND `Disable` = 0 AND `Sex` ='M'";
              $query_run = mysqli_query($con,$query);
              ?>
        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            ...
            <div class="box-body" style="overflow-x:auto;">
              <?php
              include('../../backend/connection.php');
              $query = "SELECT `Staff_ID`, `Lname`, `Mname`, `Fname`, (YEAR(CURRENT_DATE)-YEAR(DOB)) AS Age, `Marital_Status` FROM STAFF WHERE YEAR(CURRENT_DATE)-YEAR(DOB) > 40 AND YEAR(CURRENT_DATE)-YEAR(DOB) < 51 AND `Disable` = 0 AND `Sex`='M'";
              $query_run = mysqli_query($con,$query);
              ?>
        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            ...
            <div class="box-body" style="overflow-x:auto;">
              <?php
              include('../../backend/connection.php');
              $query = "SELECT `Staff_ID`, `Lname`, `Mname`, `Fname`, (YEAR(CURRENT_DATE)-YEAR(DOB)) AS Age, `Marital_Status` FROM STAFF WHERE YEAR(CURRENT_DATE)-YEAR(DOB) > 50 AND YEAR(CURRENT_DATE)-YEAR(DOB) < 61 AND `Disable` = 0 AND `Sex` = 'M'";
              $query_run = mysqli_query($con,$query);
              ?>
